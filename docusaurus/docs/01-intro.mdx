...
This was one of the best courses I have ever taken. Highly recommended!
...
:::tip Heroku coldstart

When visiting Heroku deployments (versions 1 and 2), it takes about half a minute to start container!

:::

<Tabs>
<TabItem value="v1" label="Version 1" default>
